...
export interface IControlsDefinitions {
    icon: string;
    container: string;
    updateChartOnChange: boolean;
    // updateModificationChart: () => Promise<void>;
...
export class ControlsConstants {
    ...
    static readonly MODIFICATION_PARAMS: {[K in MODIFICATION____KEY]: IControlsDefinitions} = {
        'TIME': {
            ...
            updateChartOnChange: false,
            createModificationResolver: () => new ModificationResolverTime(),
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverTime()),
        ...
        'STRAIN': {
            ...
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverStrain()),
        ...
        'CONTACT': {
            ...
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverContact()),
        ...
        'TESTING': {
            ...
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverTesting()),
        ...
        'VACCINATION': {
            ...
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverVaccination()),
        ...
        'SEASONALITY': {
            ...
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverSeasonality()),
        ...
        'SETTINGS': {
            ...
            // updateModificationChart: async () => ControlsConstants.rebuildModificationChart(new ModificationResolverSettings()),
    ...
    static rebuildModificationChart(modificationResolver: IModificationResolver<IModificationValues, IModification<IModificationValues>>): void {
        ...
        for (let instant = minChartInstant; instant <= maxChartInstant; instant += TimeUtil.MILLISECONDS_PER____DAY) {
            if (instant === maxChartInstant) {
                const value = modificationResolver.getValue(instant);
            }
