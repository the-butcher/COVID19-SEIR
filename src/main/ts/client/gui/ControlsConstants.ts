...
export class ControlsConstants {
    ...
    static readonly MODIFICATION_PARAMS: {[K in MODIFICATION____KEY]:IControlsDefinitions} = {
        ...
        'CONTACT': {
            ...
            updateChartOnChange: true,
            updateModificationChart: async () => ControlsConstants.rebuildModificationData('CONTACT', 1),
        ...
        'TESTING': {
            ...
            updateChartOnChange: true,
            updateModificationChart: async () => ControlsConstants.rebuildModificationData('TESTING', 1),
        ...
        'VACCINATION': {
            ...
            updateChartOnChange: true,
            updateModificationChart: async () => ControlsConstants.rebuildModificationData('VACCINATION', 100000),
        ...
        'SEASONALITY': {
            ...
            updateChartOnChange: true,
            updateModificationChart: async () => ControlsSeasonality.rebuildModificationData(),
    ...
    static rebuildModificationData(key: MODIFICATION____KEY, max: number): void {
