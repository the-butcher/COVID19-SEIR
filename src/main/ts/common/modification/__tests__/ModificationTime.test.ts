...
describe("test value", () => {
    ...
    //     expect(modificationTime.getQuarantineMultiplier(0)).toBeCloseTo(0.839, 3);
    //     expect(modificationTime.getQuarantineMultiplier(4)).toBeCloseTo(0.839, 3);
    //     expect(modificationTime.getQuarantineMultiplier(9)).toBeCloseTo(0.839, 3);
    // });
    ...
    //     expect(modificationTime.getTestingRatio(4)).toBeCloseTo(0.3, 3);
    //     expect(modificationTime.getTestingRatio(9)).toBeCloseTo(0.3, 3);
    //     expect(modificationTime.getQuarantineMultiplier(0)).toBeCloseTo(0.9195, 3); // with less quarantine, there will be less reduction
    //     expect(modificationTime.getQuarantineMultiplier(4)).toBeCloseTo(0.9195, 3);
    //     expect(modificationTime.getQuarantineMultiplier(9)).toBeCloseTo(0.9195, 3);
    // });
